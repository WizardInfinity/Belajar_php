        ...
        <div class="container">
          ...
          <div class=" form-row py-3 pt-5">
            <div class="input-group col-lg-10">
              <input type="text" class="form-control inp px-5" placeholder="NAMA" name="nama" id="nama" required value=" <?= $sws["nama"]; ?>">
            </div>
          </div><br>
          <div class="mb-3">
            <div class="input-group">
              <input type="text" class="form-control inp px-5" name="nis" placeholder="NIS" id="nis" required value=" <?= $sws["nis"]; ?>">
            </div>
          </div><br>
          <div class="">
            <div class="input-group">
              <input type="text" class="form-control inp px-5" name="kelas" placeholder="KELAS" id="kelas" required value=" <?= $sws["kelas"]; ?>">
            </div>
          </div>
          ...
          <br><br>
            ...
            <center><button class="btn btn-primary inp w-50" type="save"  name="save" >SIMPAN</button></center>
          </div>
