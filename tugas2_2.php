  ...
  <body>
    <section class="login py-5 bg-light">
        <div class="container">
            ...
            <br><br><br>
            <center><h2>FORM KELAS</h2>
          <div class=" form-row py-3 pt-5">
            <div class="input-group col-lg-10">
              <input type="text" class="form-control inp px-5" placeholder="KELAS" name="kelas" id="kelas">
            </div>

          
          <br><br><br><br><br><br>
          <a href="tugas2.php" class="btn btn-danger w-99" type="save"  name="save" >FORM SISWA</a>
           <button class="btn btn-primary  offset-1 w-99 " type="save"  name="save" >SIMPAN</button>
