  ...
  <body>
    <div class="container gambar rounded-5 mt-5">
            ...
            <div class="row g-0" >
                ...
                <table class="table table-striped table-hover bg-light offset-3 ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class=" ">
                                            <a class="underline text-dark" href="tabeltugas2.php">
                                            <h6>Data Siswa</h6></a>
                                        </th>
                                    </tr>
                                    <tr>
        ...
        <tr>
            ...
            <td><?= $row["kelas"]; ?></td>
            <td>
            <a href="updatetabeltugas2_2.php?id= <?= $row["id"]; ?>"><input type="button" class="btn btn-primary " value="Edit"></a>
            <a href="deletetabeltugas2_2.php?id= <?= $row["id"]; ?>" onclick = "return confirm ('Apakah Yakin Ingin Menghapus?');" ><input type="button" class="btn btn-primary " value="Delete"></a>
        </td>
        </tr>
        <?php endforeach ;?>
        </table>
        ...
        <div class="container">
            <center><a href="tugas2_2.php" class="btn btn-primary offset-4 pt-3 inp w-50" type="save"  name="save" >TAMBAH</a></center>
        </div>
    </div>
</div>
        </div>
